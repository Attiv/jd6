...
# create the zip file
zip -r jd6.zip . -x "jd6_build.zip" -x "build/*" -x ".git/*" -x ".gitignore*" -x ".history/*" -x "build.sh" -x "兰佬转词库.zip" -x "词库转换键道.zip" -x "qui.py" -x ".scripts/*" -x "chongfu.py" -x ".build_back/*" -x ".build_back" -x "zhuyin.py"
