...
| 相对路径 | 权限 | 字节数 | SHA-256 |
|---|---:|---:|---|
| `scripts/sync_qianwen_rime.sh` | `0755` | 28939 | `3b73eccc4e2fa059b8e44b53a3d4bb12861b06b028cdfcafe18e312260ab8b88` |
...
| `tests/test_sync_qianwen_rime.sh` | `0755` | 12496 | `02dabdb8636a0dc77bc2fc7c1a2d058fbbbf4e2912d35003488ee7a7f1c43820` |
...
- `status` 返回 `0`；自动更新已重新屏蔽，避免覆盖层再次被更新替换。

新版仍缺少旧兼容引擎需要的 5 个 ABI 符号，因此使用千问自带引擎。键道候选翻译可用，
但 1.2.x 已知的逐键 processor 限制仍可能影响顶功和 Lua 按键功能；需要在“千问双拼”入口实测。
